...
```bash
python evaluate.py --input_dir <insert_input_dir> \
                    --output_dir <insert_output_dir>
                    --checkpoint ./checkpoints/best_finetuned.pt
```
...
└── outputs/                 # predicted images in .png format contained in a zip file
```
